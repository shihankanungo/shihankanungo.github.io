...
<br><br>
We also had classes: one on analytic number theory, and one on parity in combo problems. The NT class was mostly just the proof of the sum over, and then there was a bit of time for problems. The parity class was fun, too. 
<br><br>
